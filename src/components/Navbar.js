...
const Navbar = () => {
  ...
  return (
    <nav className="relative z-10 w-4/5 m-auto flex justify-between items-center py-10">
      <div className="flex gap-10 items-center">
        ...
        <ul className=" justify-between items-center gap-4 font-[600] text-[1rem] hidden md:flex">
          <li className="flex items-center gap-2 cursor-pointer hover:underline group">
            Product{' '}
            <span className="group-hover:rotate-[180deg]">
              <svg
                className="h-full"
                xmlns="http://www.w3.org/2000/svg"
                width="10"
